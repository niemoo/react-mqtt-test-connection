...
class ClassMqtt extends React.Component {
  ...
  render() {
    return (
      <>
        <Connection connectBtn={this.state.connectStatus} connect={this.handleConnect} disconnect={this.handleDisconnect} />
        <QosOption.Provider value={qosOption}>
          <Subscriber showUnsub={this.state.isSubed} subscribe={this.handleSubscribe} unsubscribe={this.handleUnsub} />
